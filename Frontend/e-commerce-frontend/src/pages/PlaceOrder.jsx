    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 sm:max-w-[480px]'>
         ...
         <div className='flex gap-3'>
            <input onChange={onChangeHandler} name='firstName' value={formData.firstName} placeholder='First Name' className='border border-gray-300 rounded py-1.5 px-1.5 w-full' type="text"  id="" />
            <input onChange={onChangeHandler} name='lastName' value={formData.lastName} placeholder='Last Name' className='border border-gray-300 rounded py-1.5 px-1.5 w-full' type="text"  id="" />
            </div> 
            ...
            <input onChange={onChangeHandler} name='state' value={formData.state} placeholder='State' className='border border-gray-300 rounded py-1.5 px-1.5 w-full' type="text"  id="" />
            </div> 

            <div className='flex gap-3'>
            <input onChange={onChangeHandler} name='zipcode' value={formData.zipcode} placeholder='Pincode' className='border border-gray-300 rounded py-1.5 px-1.5 w-full' type="text"  id="" />
            <input onChange={onChangeHandler} name='phone' value={formData.phone} placeholder='Country' className='border border-gray-300 rounded py-1.5 px-1.5 w-full' type="text"  id="" />
            </div> 
